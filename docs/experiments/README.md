...
- `2026-09-03` [2026-09-03-fp2mix-v2-requant.md](2026-09-03-fp2mix-v2-requant.md) — the FP2MIX v2: PLE → Q5_1 disk-resident restores the lost n-gram recall (Dante 8k ppl 37.90 → **2.07**), FP4/Q3 trunk upgrade brings EN ppl to **3.27** (below even the LEAN) at −5.5% tg128; 75.87 GiB on disk, **55.94 GiB resident** measured at ctx 131k with `--ple-disk`; shipped in-place over the v1 shards (re-download both).
...
**What shipped:** [`patches/spec-cache-trailing-rollback/`](../../patches/spec-cache-trailing-rollback/) (9 patches, partially merged via PR #69), [`patches/ckpt-device-split-restore/`](../../patches/ckpt-device-split-restore/), [`patches/f4-boundary-save/`](../../patches/f4-boundary-save/) (2 patches), and the ring-slot writer inside [`patches/qwen4exp-mtp/`](../../patches/qwen4exp-mtp/) — all live in the production server and in the [`rocmfpx/`](../../rocmfpx/) snapshot.
