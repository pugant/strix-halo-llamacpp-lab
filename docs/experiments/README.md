...
Also in this thread, the pipeline-era specs that defined the quantize/publish infrastructure the repo still runs: [design-2026-08-11-grug-35b-v2-strix-lean.md](design-2026-08-11-grug-35b-v2-strix-lean.md) and [design-2026-08-11-hf-publish-grug-ornith.md](design-2026-08-11-hf-publish-grug-ornith.md). Dedicated notes for the salvage and ring fixes are the qwen4exp/pi-stack notes above.
