...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_OUTPUT_HC_NORM,                         "output_hc_norm" },
    { LLM_TENSOR_OUTPUT_HC_DOWN,                         "output_hc_down" },
    { LLM_TENSOR_OUTPUT_HC_UP,                           "output_hc_up" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_OUTPUT_HC_NORM,             {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    {LLM_TENSOR_OUTPUT_HC_DOWN,             {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_OUTPUT_HC_UP,               {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
